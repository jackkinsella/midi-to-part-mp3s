...
class TestMoreVoices(unittest.TestCase):
    ...
    def test_ssaa(self):
        ...
        expected_filenames = ['soprano 1.mp3', 'soprano 1 with accompaniment.mp3',
                              ...
                              'alto 2.mp3', 'alto 2 with accompaniment.mp3',
                              'all.mp3']
        self._simple_file_list_check(arguments, expected_filenames)
    ...
    def test_ssaattbb(self):
        ...
        expected_filenames = ['soprano 1.mp3', 'soprano 1 with accompaniment.mp3',
                              ...
                              'alto 1.mp3', 'alto 1 with accompaniment.mp3',
                              'alto 2.mp3', 'alto 2 with accompaniment.mp3',
                              'tenor 1.mp3', 'tenor 1 with accompaniment.mp3',
                              'tenor 2.mp3', 'tenor 2 with accompaniment.mp3',
                              'bass 1.mp3', 'bass 1 with accompaniment.mp3',
                              'bass 2.mp3', 'bass 2 with accompaniment.mp3',
                              'all.mp3']
        self._simple_file_list_check(arguments, expected_filenames)

    def _simple_file_list_check(self, arguments: List[str], expected_filenames: List[str]):
