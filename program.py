...
midifile_path = 'midis/sanctus.mid'
description = {
  "soprano": [0,1,2],
  "alt": [0,1,3],
  "tenor": [0,1,4],
...
def isolate_tracks(track_numbers, output_filename):
...
def separate_tracks_into_mp3s(description):
  for track_name, track_numbers in description.items():
    convert_midi_to_mp3(isolate_tracks(track_numbers, track_name))

change_instrument(0)
separate_tracks_into_mp3s(description)